		...
		**/
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name'          	=> 'tpb_options', // This is where your data is stored in the database and also becomes your global variable name.
				'display_name'			=> 'Theme Options', // $theme->get('Name'), // Name that appears at the top of your panel
				'display_version'		=> '', //$theme->get('Version'), // Version that appears at the top of your panel
				'menu_type'          	=> 'menu', //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
				'allow_sub_menu'     	=> true, // Show the sections below the admin menu item or not
				'menu_title'			=> __( 'Theme Options', 'brew-framework' ),
	            'page'		 	 		=> __( 'Theme Options', 'brew-framework' ),
			...
			$this->args['share_icons'][] = array(
			    'url' => 'http://twitter.com/plusplusminus',
			...
			// Panel Intro text -> before the form
				...
				$this->args['intro_text'] = __('<p>Here you can make changes to your website</p>', 'brew-framework');
